...
module Tests = struct
  ...
  let%expect_test "empty vector" =
    run_it "[||]";
    [%expect
      {| (Uvector(values())(mutability Immutable)(span(Span(filename"")(start(Position(line 1)(column 0)))(finish(Position(line 1)(column 4)))))) |}]
